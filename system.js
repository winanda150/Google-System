...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (form1) {
    ...
    var errorIcon1 = form1.querySelector('.Logoerror1');
    var errorMsg1 = form1.querySelector('.error-msg1');
    form1.setAttribute('novalidate', true);

    form1.addEventListener('submit', function(e) {
      if (!emailInput1.value) {
        e.preventDefault();
        errorIcon1.style.display = 'flex';
  ...
  if (form2) {
    ...
    var errorIcon2 = form2.querySelector('.Logoerror2');
    var errorMsg2 = form2.querySelector('.error-msg2');
    ...
    form2.addEventListener('submit', function(e) {
      if (!emailInput.value) {
        ...
        errorMsg2.textContent = "Masukkan email atau nomor telepon";
        emailInput.style.borderColor = "#d93025";
        emailInput.style.borderWidth = "2px";
      } else if (!emailInput.checkValidity()) {
        e.preventDefault();
        errorIcon2.style.display = 'flex';
        errorMsg2.textContent = "Masukkan email atau nomor telepon yang valid";
        emailInput.style.borderColor = "#d93025";
        emailInput.style.borderWidth = "2px";
      } else {
...
function MobileElements() {
  ...
  if (Mobile) {
    ...
    Mobile.style.marginTop = 'calc(50vh - 240px)';
